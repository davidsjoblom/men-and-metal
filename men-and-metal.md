...
A unit is considered to be maintaining Unit Cohesion when:
* All models are within Cohesion Distance of at least one other model in the unit, and
...
#### Target Number
The Target Number (TN) is the value a rolled D10 needs to equal or be less than to be considered a success. A roll that exceeds the TN is considered a fail. A TN is calculated by taking the base TN and applying any applicable modifiers to it, e.g. a base TN of 3 with a +1 modifier results in a final TN of 4.
### Tokens & Markers
...
Visually striking glass beads are preferably used to make tracking pins easy for both players.
#### Objective makers
Objective markers are used to specify a point or a terrain feature on the battlefield as Key terrain.
...
* Armored Vehicle
### Cohesion Distance
The distance used to determine Unit Cohesion.
### Base Size
...
### Speed
A unit's Speed is how far it moves during a Move action.
### Quality
The Quality of a unit represents it's ability to mitigate incoming fire through a combination of training and equipment.
* Green; enemy units gains a +1 TN modifier to hit when targeting this unit.
* Regular; no modifier.
* Elite; enemy units suffer a -1 TN modifier to hit when targeting this unit.
### Armor
### Discipline
A unit's Discipline determines the Target Number for Rally tests.
* Reluctant (TN2)
* Eager (TN3)
* Stubborn (TN4)
* Fanatical (TN5)
...
Then randomly determine (50/50 odds) which player will be the Starting player for this Round.
...
The players now score Victory points based on the scenario being played.
## Orders
### Advance Order
...
The base Target Number for this roll is the Discipline of the unit.
