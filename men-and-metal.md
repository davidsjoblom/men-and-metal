...
All dice used are six-sided dice, abbreviated as D6.
...
All units have a unique Unit Name.
...
1. _Declare Targets_
2. _Resolve Attacks_
   1. _Check Which Models Can Attack_
   2. _Roll Combat Test_
   3. _Place Pins_
   4. _Mark Inflicted Casualties_
3. _Remove Casualties_
...
Each faction will have its own 'deck' of Stratagems that a player can choose from during the game.
Factions may share some Stratagems and may have duplicates, representing a more plentiful supply.
During the Command Phase each player gets to privately choose one Stratagem card from their deck.
How and when a card is played depends on the Stratagem itself.

Some potential stratagems:
