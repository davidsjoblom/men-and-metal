...
### Battlefield Interpetation
Allthough models and terrain features on the battlefield do exist in 3D, the actual game takes place in a 2D plane corresponding to the dimensions of the battlefield itself.
...
This functons simillarly but serves as reminder of how Vehicles interact differently with some types of 
...
## 2.7. Resolve
A unit's Resolve represents its ability to keep fighting under pressure and shake off supression.
